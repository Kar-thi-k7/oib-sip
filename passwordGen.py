...
def generate_pasword(length, use_letters = True, use_numbers = True, use_symbols=True):
    selection_list = ''
    if use_letters:
    ...
    if not selection_list:
        print("Please select st least one character type.")
        return None
...
def main():
    ...
    password = generate_pasword(length, use_letters, use_numbers, use_symbols)
